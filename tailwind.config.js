  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'primary': '0 4px 20px rgba(102, 126, 234, 0.15)',
        'primary-lg': '0 10px 30px rgba(102, 126, 234, 0.2)',
        'secondary': '0 4px 20px rgba(147, 51, 234, 0.15)',
